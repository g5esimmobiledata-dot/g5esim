...
const MyDIDs = lazy(() => import('@/pages/MyDIDs'));
...
const agentNavigation: ResellerNavItem[] = [
  ...
  { name: 'Orders', href: '/account/orders', icon: Package, moduleKey: 'module_order_management' },
  {
    ...
    children: [
      ...
      { name: 'My eRoaming', href: '/account/my-dids', icon: PhoneCall, moduleKey: 'module_virtual_numbers' },
    ],
  },
  {
    name: 'IPTV Services',
  ...
  return (
    <ModuleDashboardPage
      ...
      actions={[
        ...
        { title: 'My eRoaming', description: 'Open bought eRoaming numbers for SMS, calls, receiving SMS, and Voice Mail.', href: '/account/my-dids', icon: PhoneCall },

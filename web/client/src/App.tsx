...
const AccountLayout = lazy(() => import('./components/layout/AccountLayout').then((m) => ({ default: m.AccountLayout })));
const AdminShell = lazy(() => import('./components/admin/AdminShell'));
const ResellerShell = lazy(() => import('./components/reseller/ResellerShell'));
const AccountShell = lazy(() => import('./components/layout/AccountShell').then((m) => ({ default: m.AccountShell })));
const GlobalFloatingNav = lazy(() => import('./components/GlobalFloatingNav').then((m) => ({ default: m.GlobalFloatingNav })));
...
const PUBLIC_ROUTES = [
  ...
  { path: '/telegram', component: TelegramMiniApp, layout: 'empty' as any },

...
function tierClass(tier?: string) {
  if (tier === 'gold') return 'border-amber-300 bg-amber-50 text-amber-800';
  if (tier === 'platinum') return 'border-cyan-300 bg-cyan-50 text-cyan-800';
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  <Badge
                    variant="outline"
                    className={cn('no-default-hover-elevate gap-1 shadow-none', tierClass(rewards?.tier?.key || user?.memberTier))}
                  >
                  ...
                  <Badge
                    variant="outline"
                    className={cn('no-default-hover-elevate gap-1 shadow-none', statusClass(user?.kycStatus))}
                  >
                  ...
                  <Badge
                    variant="outline"
                    className="no-default-hover-elevate border-slate-300 bg-white text-slate-800 shadow-none capitalize"
                  >
                    {user?.role || 'customer'}
                  </Badge>
                </div>

...
export function ConciergeAccessCard({
  ...
  return (
    <>
      <Card className="border-lime-300/20 bg-gradient-to-r from-lime-300/10 to-amber-300/10 text-white shadow-xl shadow-black/10">
        <CardContent className="flex flex-col gap-4 p-6 md:flex-row md:items-center md:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-white">VIP Concierge</h2>
              ...
              <p className="mt-2 text-xs font-medium uppercase tracking-wide text-lime-300">
                {livePricingLabel}
              </p>
              {displayedFeatures.length > 0 && (
                <div className="mt-3 flex flex-wrap gap-2">
                  {displayedFeatures.slice(0, 5).map((feature) => (
                    <span
                      key={feature}
                      className="rounded-full border border-lime-300/20 bg-slate-950/40 px-3 py-1 text-xs text-slate-100"
                    >
                      {feature}
                    </span>
                  ))}
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            {hotlineUrl && (
              <Button
                ...
                className="gap-2 border-lime-400/50 bg-white/80 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-slate-950/30"
              >
              ...
              <>
                {data?.trialAvailable && (
                  <Button
                    ...
                    disabled={activating}
                    variant="outline"
                    className="gap-2 border-lime-400/50 bg-white/80 dark:bg-slate-950/30"
                  >

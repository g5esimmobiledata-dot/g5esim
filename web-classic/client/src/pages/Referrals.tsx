        ...
        <motion.div variants={itemVariants} className="lg:col-span-2">
          <Card className="h-full border-none shadow-xl overflow-hidden bg-white dark:bg-zinc-900/50">
            ...
            <CardHeader className="pb-2">
              <CardTitle className="text-xl font-bold">{t('userPanel.referrals.yourCode', 'Your Referral Program')}</CardTitle>
              <CardDescription>{t('userPanel.referrals.shareVia', 'Share this code or link with your friends to start earning.')}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-8 pt-4">
              <div className="p-8 rounded-3xl bg-slate-50 dark:bg-zinc-800/50 border border-slate-100 dark:border-zinc-700/50 flex flex-col items-center justify-center text-center space-y-6 relative group">
                <div className="space-y-1">
                  <p className="text-xs font-bold text-teal-600 uppercase tracking-[0.2em]">Personal Invite Code</p>
                ...
                <div className="flex flex-wrap gap-3 justify-center">
                  <Button
                    variant="outline"
                    size="lg"
                    className="rounded-2xl h-14 px-8 border-2 hover:bg-teal-50 dark:hover:bg-teal-900/10 hover:border-teal-500 transition-all group/btn"
                    onClick={() => copyToClipboard(program?.referralCode || '', 'code')}
                  >
                    <Copy className="h-5 w-5 mr-3 text-muted-foreground group-hover/btn:text-teal-500 transition-colors" />
                    <span className="font-semibold">{t('userPanel.referrals.copyCode', 'Copy Code')}</span>
                  </Button>
                  <Button
                    variant="default"
                    size="lg"
                    className="rounded-2xl h-14 px-8 bg-teal-600 hover:bg-teal-700 shadow-lg shadow-teal-500/20 transition-all"

...
DataPackModel dataPackModelFromJson(String str) =>
    DataPackModel.fromJson(json.decode(str));

String dataPackModelToJson(DataPackModel data) => json.encode(data.toJson());
...
class DataPackModel {
  ...
  DataPackModel({this.success, this.message, this.data});

  factory DataPackModel.fromJson(Map<String, dynamic> json) => DataPackModel(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    providerPackageTable:
        providerPackageTableValues.map[json["providerPackageTable"]],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "providerPackageTable":
        providerPackageTableValues.reverse[providerPackageTable],
...
final nameValues = EnumValues({"Airalo": Name.AIRALO});

enum Slug { AIRALO }

final slugValues = EnumValues({"airalo": Slug.AIRALO});

enum ProviderPackageTable { AIRALO_PACKAGES }

final providerPackageTableValues = EnumValues({
  "airalo_packages": ProviderPackageTable.AIRALO_PACKAGES,
});

enum Type { LOCAL }

final typeValues = EnumValues({"local": Type.LOCAL});

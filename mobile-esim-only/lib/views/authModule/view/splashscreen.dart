...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    _navigateAfterDelay();
    if (!kIsWeb) {
      _setupFCMHandlersWhenReady();
    }
    _fetcCurrency();
  }

  Future<void> _setupFCMHandlersWhenReady() async {
    ...
    log('FCM handlers skipped: Firebase is not initialized');
  }
  ...
  void _setupFCMHandlers() {
    try {
      ...
      FirebaseMessaging.instance
          ...
          .catchError((error) {
            log('Initial notification check skipped: $error');
            return null;
          });
    } catch (error) {
      log('FCM handlers skipped: $error');
    }
  }

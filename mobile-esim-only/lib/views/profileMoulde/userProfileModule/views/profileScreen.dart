...
import 'package:esimconnect/views/profileMoulde/userProfileModule/views/deleteAccountScreen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  bool _moduleEnabled(String key) => moduleAccess.enabled(key, fallback: true);
